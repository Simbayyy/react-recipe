...
const IngredientCard: React.FunctionComponent<IngredientRaw> = (ingredient) => {
  return (
    <div
      key={ingredient.ingredient_id}
      className={`ingredient__card ${
        ingredient.high_confidence ? "ingredient__trusty" : ""
      }`}
    >
...
export const IngredientList: React.FunctionComponent =
  (): React.ReactElement => {
    const { ingredients } = useIngredients();

    return (
      <div className="ingredient__cards">
